  ...
  return (
    <header className="w-full bg-[#efefec] flex items-center justify-between px-6 py-4 border-b border-black/5 z-50">
      ...
      <div className="flex-1">
        <a
          href="/"
          className="text-2xl font-bold tracking-tight text-black w-fit"
        >
          The Syntax
        </a>
      </div>
      ...
      {/* Navigation */}
      <nav className="hidden md:flex flex-1 justify-center space-x-10 lg:space-x-16">
        <p className="text-sm font-medium text-black hover:opacity-60 transition-opacity cursor-pointer">
          Home
        </p>
      ...
      <div className="flex-1 flex justify-end">
        <button
          className="flex flex-col items-center justify-center w-14 h-8 rounded-full border border-black hover:bg-black/5 transition-colors gap-[3px]"
