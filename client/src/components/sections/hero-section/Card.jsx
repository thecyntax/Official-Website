...
const Card = () => {
  return (
    <div className="group/card flex items-center gap-5 bg-white/90 backdrop-blur-md border border-gray-200 rounded-2xl shadow-xl px-6 py-5 max-w-[360px] hover:shadow-2xl transition-all duration-500">
      {/* Lottie Container - Floats up on card hover */}
      <div className="group-hover/card:-translate-y-2 transition-transform duration-500 ease-in-out">
        <Lottie
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-[14px] text-gray-500">Let’s bring it to life.</p>
        ...
        <div className="relative group w-fit mt-2">
          ...
          <button
            className="relative flex items-center cursor-pointer gap-3 bg-black text-white px-5 py-2.5 rounded-full leading-none 
  transition-all duration-200 hover:bg-zinc-900 active:scale-95"
          >
            <span className="text-[13px] font-semibold">Get in Touch</span>
